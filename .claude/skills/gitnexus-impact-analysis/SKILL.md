...
> If `.gitnexus/run.cjs` is missing, replace `node .gitnexus/run.cjs` with `npx gitnexus@1.6.12` in the fallback commands; `gitnexus-cli` documents the pinned Bun and pnpm alternatives.
