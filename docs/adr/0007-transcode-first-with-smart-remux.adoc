...
This gives us one complete-ladder job path through `TranscodeWorkerPort` and the local transcode engine for all sessions, whether REMUX, PARTIAL_TRANSCODE, or FULL_TRANSCODE.
