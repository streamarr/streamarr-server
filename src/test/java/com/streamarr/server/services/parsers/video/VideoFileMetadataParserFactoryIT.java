...
public class VideoFileMetadataParserFactoryIT {
  ...
  @MockitoSpyBean private ExternalIdVideoFileMetadataParser externalIdVideoFileMetadataParserSpy;

  @MockitoSpyBean private DefaultVideoFileMetadataParser defaultVideoFileMetadataParserSpy;
  ...
  @Test
  @DisplayName(
      "Should only attempt to parse video's external id when given filename and not attempt to parse title")
  ...
  @Test
  @DisplayName(
      "Should attempt to parse video's external id and name and year when given filename containing only title and no tags")
