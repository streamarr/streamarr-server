...
public class ProbeExecutionException extends TranscodeException {
  ...
  public ProbeExecutionException(ItemFailureReason reason, String message) {
    super(message);
    this.reason = reason;
  }

  public ProbeExecutionException(ItemFailureReason reason, String message, Throwable cause) {
    super(message, cause);
    this.reason = reason;
  }
