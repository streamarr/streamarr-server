...
public final class IdentityLifecycleErrors {
  ...
  private IdentityLifecycleErrors() {}
  ...
  public static AdministrativelyDeleteAccountError toAdministrativelyDeleteAccountError(
      TransferRejections.AdministrativelyDeleteAccount rejection) {
    return switch (rejection) {
      case TransferRejections.AccountNotFound _ -> accountNotFound();
