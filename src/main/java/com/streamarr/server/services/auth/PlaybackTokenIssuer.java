 ...
 * identity claims plus the stream-session binding. Scope is playback: outside the hierarchy, these
 * tokens authorize nothing but stream paths. Validity covers one media traversal plus the
 * configured retention window for pause and slow-playback slack; persisted playback authority is
