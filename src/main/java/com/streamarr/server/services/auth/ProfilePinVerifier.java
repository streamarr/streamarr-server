 ...
 * throttled on the PROFILE_PIN budget keyed by Account and Profile. The verified result is trusted
 * attempt context the selection service alone creates; no client supplies it.
 */
@Slf4j
@Component
