...
final class IntentPlanner {
  ...
  IntentPlan<AuthorizationUnit> plan(
    ...
    return switch (intent) {
      ...
      case Intent.AdministrativelyDeleteAccount(var accountId) ->
          unitPlan(AuthorizationCheck.onAccount(Action.ADMINISTRATIVELY_DELETE_ACCOUNT, accountId));
      ...
      case Intent.DeleteHousehold(var householdId) ->
          unitPlan(AuthorizationCheck.onHousehold(Action.DELETE_HOUSEHOLD, householdId));
