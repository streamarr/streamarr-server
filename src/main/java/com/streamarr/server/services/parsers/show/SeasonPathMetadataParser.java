...
public class SeasonPathMetadataParser implements MetadataParser<SeasonPathMetadataParser.Result> {
    ...
    private Result getSeasonNumberFromPath(String path, boolean supportSpecialAliases, boolean supportNumericSeasonFolders) {
    ...
    private Optional<Result> getSeasonNumberFromPathSubstring(String path) {
        ...
        var optionalSeasonNumber = tryStringToOptionalIntConversion(path.substring(numericStart, length + numericStart));
