...
public class Indexes {
    ...
    public static final Index IDX_AUTH_SESSION_ACTIVE_PROFILE_ID = Internal.createIndex(DSL.name("idx_auth_session_active_profile_id"), AuthSession.AUTH_SESSION, new OrderField[] { AuthSession.AUTH_SESSION.ACTIVE_PROFILE_ID }, false);
    ...
    public static final Index IDX_PROFILE_HOUSEHOLD_SHARE_HOUSEHOLD_ID = Internal.createIndex(DSL.name("idx_profile_household_share_household_id"), ProfileHouseholdShare.PROFILE_HOUSEHOLD_SHARE, new OrderField[] { ProfileHouseholdShare.PROFILE_HOUSEHOLD_SHARE.HOUSEHOLD_ID }, false);
    ...
    public static final Index IDX_SECURITY_AUDIT_EVENT_ACTOR = Internal.createIndex(DSL.name("idx_security_audit_event_actor"), SecurityAuditEvent.SECURITY_AUDIT_EVENT, new OrderField[] { SecurityAuditEvent.SECURITY_AUDIT_EVENT.ACTING_ACCOUNT_ID }, false);
    public static final Index IDX_SECURITY_AUDIT_EVENT_PROFILE = Internal.createIndex(DSL.name("idx_security_audit_event_profile"), SecurityAuditEvent.SECURITY_AUDIT_EVENT, new OrderField[] { SecurityAuditEvent.SECURITY_AUDIT_EVENT.TARGET_PROFILE_ID }, false);
    ...
    public static final Index UQ_PROFILE_MANAGER_INVITATION_PENDING = Internal.createIndex(DSL.name("uq_profile_manager_invitation_pending"), ProfileManagerInvitation.PROFILE_MANAGER_INVITATION, new OrderField[] { ProfileManagerInvitation.PROFILE_MANAGER_INVITATION.PROFILE_ID, ProfileManagerInvitation.PROFILE_MANAGER_INVITATION.INVITED_ACCOUNT_ID }, true);
    ...
    public static final Index UQ_USER_ACCOUNT_HOUSEHOLD_OWNER = Internal.createIndex(DSL.name("uq_user_account_household_owner"), UserAccount.USER_ACCOUNT, new OrderField[] { UserAccount.USER_ACCOUNT.HOME_HOUSEHOLD_ID }, true);
}
