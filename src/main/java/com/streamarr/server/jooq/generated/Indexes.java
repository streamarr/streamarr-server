...
public class Indexes {
    ...
    public static final Index IDX_WATCH_PROGRESS_USER_ID = Internal.createIndex(DSL.name("idx_watch_progress_user_id"), WatchProgress.WATCH_PROGRESS, new OrderField[] { WatchProgress.WATCH_PROGRESS.USER_ID }, false);
