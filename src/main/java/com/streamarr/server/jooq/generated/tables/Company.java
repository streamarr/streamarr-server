...
public class Company extends TableImpl<CompanyRecord> {
    ...
    public Company where(Condition condition) {
        return new Company(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Company whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Company whereNotExists(TableLike<?> select) {
