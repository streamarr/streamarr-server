...
public class Keys {
    ...
    public static final ForeignKey<FileProcessingTaskRecord, MediaFileRecord> FILE_PROCESSING_TASK__FILE_PROCESSING_TASK_MEDIA_FILE_ID_FKEY = Internal.createForeignKey(FileProcessingTask.FILE_PROCESSING_TASK, DSL.name("file_processing_task_media_file_id_fkey"), new TableField[] { FileProcessingTask.FILE_PROCESSING_TASK.MEDIA_FILE_ID }, Keys.MOVIE_FILE_PKEY, new TableField[] { MediaFile.MEDIA_FILE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
