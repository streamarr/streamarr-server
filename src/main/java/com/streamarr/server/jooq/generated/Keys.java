...
public class Keys {
    ...
    public static final UniqueKey<RefreshTokenRecord> UQ_REFRESH_TOKEN_PREDECESSOR = Internal.createUniqueKey(RefreshToken.REFRESH_TOKEN, DSL.name("uq_refresh_token_predecessor"), new TableField[] { RefreshToken.REFRESH_TOKEN.PREDECESSOR_ID }, true);
    ...
    public static final ForeignKey<RefreshTokenRecord, RefreshTokenRecord> REFRESH_TOKEN__FK_REFRESH_TOKEN_PREDECESSOR = Internal.createForeignKey(RefreshToken.REFRESH_TOKEN, DSL.name("fk_refresh_token_predecessor"), new TableField[] { RefreshToken.REFRESH_TOKEN.PREDECESSOR_ID }, Keys.REFRESH_TOKEN_PKEY, new TableField[] { RefreshToken.REFRESH_TOKEN.ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.NO_ACTION);
