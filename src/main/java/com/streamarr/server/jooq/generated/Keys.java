...
public class Keys {
    ...
    public static final UniqueKey<ItemResultRecord> ITEM_RESULT_IDENTITY = Internal.createUniqueKey(ItemResult.ITEM_RESULT, DSL.name("item_result_identity"), new TableField[] { ItemResult.ITEM_RESULT.ITEM_ID, ItemResult.ITEM_RESULT.ITEM_TYPE, ItemResult.ITEM_RESULT.STEP, ItemResult.ITEM_RESULT.IMAGE_TYPE }, true);
    ...
    public static final UniqueKey<MediaFileContainerInfoRecord> MEDIA_FILE_CONTAINER_INFO_PKEY = Internal.createUniqueKey(MediaFileContainerInfo.MEDIA_FILE_CONTAINER_INFO, DSL.name("media_file_container_info_pkey"), new TableField[] { MediaFileContainerInfo.MEDIA_FILE_CONTAINER_INFO.MEDIA_FILE_ID }, true);
    public static final UniqueKey<MediaFileProbeTaskRequestRecord> MEDIA_FILE_PROBE_TASK_REQUEST_PKEY = Internal.createUniqueKey(MediaFileProbeTaskRequest.MEDIA_FILE_PROBE_TASK_REQUEST, DSL.name("media_file_probe_task_request_pkey"), new TableField[] { MediaFileProbeTaskRequest.MEDIA_FILE_PROBE_TASK_REQUEST.MEDIA_FILE_ID }, true);
    public static final UniqueKey<MediaFileStreamInfoRecord> MEDIA_FILE_STREAM_INFO_PKEY = Internal.createUniqueKey(MediaFileStreamInfo.MEDIA_FILE_STREAM_INFO, DSL.name("media_file_stream_info_pkey"), new TableField[] { MediaFileStreamInfo.MEDIA_FILE_STREAM_INFO.MEDIA_FILE_ID, MediaFileStreamInfo.MEDIA_FILE_STREAM_INFO.STREAM_INDEX }, true);
    ...
    public static final ForeignKey<MediaFileContainerInfoRecord, MediaFileRecord> MEDIA_FILE_CONTAINER_INFO__MEDIA_FILE_CONTAINER_INFO_MEDIA_FILE_ID_FKEY = Internal.createForeignKey(MediaFileContainerInfo.MEDIA_FILE_CONTAINER_INFO, DSL.name("media_file_container_info_media_file_id_fkey"), new TableField[] { MediaFileContainerInfo.MEDIA_FILE_CONTAINER_INFO.MEDIA_FILE_ID }, Keys.MOVIE_FILE_PKEY, new TableField[] { MediaFile.MEDIA_FILE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<MediaFileProbeTaskRequestRecord, MediaFileRecord> MEDIA_FILE_PROBE_TASK_REQUEST__MEDIA_FILE_PROBE_TASK_REQUEST_MEDIA_FILE_ID_FKEY = Internal.createForeignKey(MediaFileProbeTaskRequest.MEDIA_FILE_PROBE_TASK_REQUEST, DSL.name("media_file_probe_task_request_media_file_id_fkey"), new TableField[] { MediaFileProbeTaskRequest.MEDIA_FILE_PROBE_TASK_REQUEST.MEDIA_FILE_ID }, Keys.MOVIE_FILE_PKEY, new TableField[] { MediaFile.MEDIA_FILE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<MediaFileStreamInfoRecord, MediaFileContainerInfoRecord> MEDIA_FILE_STREAM_INFO__MEDIA_FILE_STREAM_INFO_MEDIA_FILE_ID_FKEY = Internal.createForeignKey(MediaFileStreamInfo.MEDIA_FILE_STREAM_INFO, DSL.name("media_file_stream_info_media_file_id_fkey"), new TableField[] { MediaFileStreamInfo.MEDIA_FILE_STREAM_INFO.MEDIA_FILE_ID }, Keys.MEDIA_FILE_CONTAINER_INFO_PKEY, new TableField[] { MediaFileContainerInfo.MEDIA_FILE_CONTAINER_INFO.MEDIA_FILE_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
