...
public class Keys {
    ...
    public static final UniqueKey<MediaFileProbeRequestRecord> MEDIA_FILE_PROBE_REQUEST_PKEY = Internal.createUniqueKey(MediaFileProbeRequest.MEDIA_FILE_PROBE_REQUEST, DSL.name("media_file_probe_request_pkey"), new TableField[] { MediaFileProbeRequest.MEDIA_FILE_PROBE_REQUEST.MEDIA_FILE_ID }, true);
    ...
    public static final ForeignKey<MediaFileProbeRequestRecord, MediaFileRecord> MEDIA_FILE_PROBE_REQUEST__MEDIA_FILE_PROBE_REQUEST_MEDIA_FILE_ID_FKEY = Internal.createForeignKey(MediaFileProbeRequest.MEDIA_FILE_PROBE_REQUEST, DSL.name("media_file_probe_request_media_file_id_fkey"), new TableField[] { MediaFileProbeRequest.MEDIA_FILE_PROBE_REQUEST.MEDIA_FILE_ID }, Keys.MOVIE_FILE_PKEY, new TableField[] { MediaFile.MEDIA_FILE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
