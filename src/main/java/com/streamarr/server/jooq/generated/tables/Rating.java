...
public class Rating extends TableImpl<RatingRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_RATING_MOVIE_ID);
    }
    ...
    public Rating where(Condition condition) {
        return new Rating(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Rating whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Rating whereNotExists(TableLike<?> select) {
