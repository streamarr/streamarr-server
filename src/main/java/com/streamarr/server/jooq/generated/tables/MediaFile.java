...
import com.streamarr.server.jooq.generated.tables.MediaFileProbeRequest.MediaFileProbeRequestPath;
...
public class MediaFile extends TableImpl<MediaFileRecord> {
    ...
    private transient MediaFileProbeRequestPath _mediaFileProbeRequest;

    /**
     * Get the implicit to-many join path to the
     * <code>public.media_file_probe_request</code> table
     */
    public MediaFileProbeRequestPath mediaFileProbeRequest() {
        if (_mediaFileProbeRequest == null)
            _mediaFileProbeRequest = new MediaFileProbeRequestPath(this, null, Keys.MEDIA_FILE_PROBE_REQUEST__MEDIA_FILE_PROBE_REQUEST_MEDIA_FILE_ID_FKEY.getInverseKey());

        return _mediaFileProbeRequest;
    }
