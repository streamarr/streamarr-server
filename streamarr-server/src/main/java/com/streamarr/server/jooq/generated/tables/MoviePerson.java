...
public class MoviePerson extends TableImpl<MoviePersonRecord> {
    ...
    public MoviePerson where(Condition condition) {
        return new MoviePerson(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public MoviePerson whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public MoviePerson whereNotExists(TableLike<?> select) {
