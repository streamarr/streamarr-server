...
public class MovieCompany extends TableImpl<MovieCompanyRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_MOVIE_COMPANY_COMPANY_ID, Indexes.IDX_MOVIE_COMPANY_MOVIE_ID);
    }
    ...
    public MovieCompany where(Condition condition) {
        return new MovieCompany(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public MovieCompany whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public MovieCompany whereNotExists(TableLike<?> select) {
